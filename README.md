...
|Reference  |Name                          |Purpose                                   |Qty|Cost (USD)                    |LINK                                                                                  |Distributor|
|-----------|------------------------------|------------------------------------------|---|------------------------------|--------------------------------------------------------------------------------------|-----------|
|DS1        |Monochrome_OLED_128X64_.96_I2C|Display Count Down, Distraction Notif, ect|1  |6.99                          |https://a.co/d/0dFfSqWY                                                               |Amazon     |
|J1,J2      |Male Pin Header-1x8-P2.54mm   |For mounting to Arduino UNO               |2  |11.99                         |https://a.co/d/0gofrzR4 (Bulk order applicable for other projects)                    |Amazon     |
...
|           |PCB                           |For mounting and connecting all components|1  |(Global Direct Shipping) 11.31|https://www.pcbway.com/orderonline.aspx?outsideid=d9d46809-3d4a-4ff4-aac3-b91ac39b3b48|PCBWAY     |
